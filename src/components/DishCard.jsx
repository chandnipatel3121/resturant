...
import { Clock, Users, Flame, Plus, Sparkles } from "lucide-react"

export default function DishCard({ dish, onOpenDetails, onAddToCart }) {
  const dietType = dish.diet?.toLowerCase() || "veg"
  const dietClass =
    dietType === "non-veg"
      ? "non-veg"
      : dietType === "vegan" || dietType === "jain"
        ? "jain"
        : "veg"
  ...
  return (
    ...
    >
          ...
          <div className="spice-indicator-pill">
            {[...Array(3)].map((_, i) => (
              <Flame
                ...
                color={
                  i < (dish.spiceLevel || 1) ? "#ff4d4d" : "rgba(0,0,0,0.1)"
                }
              />
            ))}
          </div>
      ...
      <div className="card-content">
        ...
        <p className="dish-desc-simple">
          {dish.description || "Freshly prepared dish."}
        </p>

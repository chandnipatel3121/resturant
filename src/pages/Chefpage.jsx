...
const chefs = [
  {
    ...
    heroDesc:
      "Crafting unforgettable sensory experiences where modern culinary science converges with raw emotional storytelling. A pioneer in high-contrast gastronomy.",
    heroImage:
    ...
    philosophyQuote:
      "I do not cook to merely feed. I cook to capture a transient moment in nature—the smell of mountain pine after heavy rain, the warmth of charcoal embers on cold winter skin—and translate it onto your plate.",
    philosophyImageLarge:
      "https://images.unsplash.com/photo-1556911220-bff31c812dba?q=80&w=1200&auto=format&fit=crop",
    philosophyImageSmall:
    ...
    dishes: [
      {
        ...
        chefNote:
          "An homage to the rich soils of Northern Italy blended with the royal saffron valleys of Kashmir. Every bite carries a sense of grounding luxury and delicate floral aroma.",
      },
      {
        id: "aarav-dish-2",
        ...
        chefNote:
          "This dish is about pure woodfire elementals—smoke, fire, and absolute heat precision. The rich marbling of Wagyu is cut perfectly by the deep resinous aroma of smoked juniper.",
      },
      {
        id: "aarav-dish-3",
        ...
        ingredients: [
          "Porcini Essence",
          "Dehydrated Wild Lichen",
          "Wild Garlic Buds",
          "Spruce Shoot Oil",
        ],
        chefNote:
          "An immersive sensory walk through a mist-shrouded Himalayan pine forest. Every element is designed to engage touch, smell, and deep forest earthiness simultaneously.",
      },
    ],
    toolkit: [
      {
    ...
    awards: [
      ...
      {
        title: "Innovative Plate Award",
        source: "World Gastronomy Federation",
      },
  ...
  },
  {
    ...
    heroDesc:
      "Deconstructing classic dessert architecture to compose edible sculptures. Merging molecular precision with delicate botanical distillations and organic floral notes.",
    heroImage:
      "https://images.unsplash.com/photo-1581299894007-aaa50297cf16?q=80&w=1200&auto=format&fit=crop",
    awardsBadges: [
    ...
    philosophyQuote:
      "Pastry is a dialogue between tension and release. The crisp snap of sugar, the chill of botanical sorbets, and the sudden warmth of spiced caramel evoke visceral emotional responses.",
    philosophyImageLarge:
    ...
    dishes: [
      {
        ...
        chefNote:
          "A playful, multi-sensory tribute to Indian summers. The snap of chocolate, the warmth of cardamom, and freezing coconut snow trigger immediate childhood nostalgia.",
      },
      {
        id: "miriam-dish-2",
        ...
        chefNote:
          "The jasmine flowers are freshly picked at dawn. The poaching broth is highly reduced to intensify the floral perfume while maintaining the pear's natural bite.",
      },
      {
        id: "miriam-dish-3",
        ...
        ingredients: [
          ...
          "Liquid Nitrogen Buds",
          "Wild Raspberries",
        ],
        chefNote:
          "Traditional pavlova reimagined as a weightless, freezing cloud. The cold lavender buds shatter on contact, perfuming the entire palate instantly.",
      },
    ],
    toolkit: [
      {
    ...
    awards: [
      ...
      {
        title: "Innovator in Botanical Baking",
        source: "Green Culinary Guild",
      },
      {
        title: "Top 10 Sweet Designers",
        source: "Dessert Digest International",
      },
    ],
  },
  {
    ...
    heroDesc:
      "Exploring the primitive depths of woodfire, smoke, and live-flame chemistry. Merging ancient Japanese binchotan techniques with wild rustic forest flavors.",
    heroImage:
    ...
    philosophyQuote:
      "Smoke is an active ingredient, not a cooking byproduct. The intense wood sap, the searing heat of binchotan, and the slow, deep caramelization of fats reveal the true soul of food.",
    philosophyImageLarge:
    ...
    dishes: [
      {
        ...
        chefNote:
          "Pure woodfire elementals—smoke, fire, and absolute heat precision. The rich marbling of Wagyu is cut perfectly by the deep resinous aroma of smoked juniper.",
      },
      {
        id: "koji-dish-2",
        ...
        chefNote:
          "Charring the octopus creates a complex bitter-sweet crust that contrasts beautifully with the rich, earthy sweetness of the slow ash-roasted sweet potato.",
      },
      {
        id: "koji-dish-3",
        ...
        chefNote:
          "Cherry wood smoke has a subtle sweetness that wraps around the rich duck fat, while the five-spice honey glaze caramelizes into a deep shell.",
      },
    ],
    toolkit: [
      {
    ...
    awards: [
      ...
      {
        title: "Leader of Open Fire Dining",
        source: "Global Gastronomy Council",
      },
      {
        title: "Ancient Techniques Pioneer",
        source: "World Gastronomy Federation",
      },
...
const ChefPage = () => {
  ...
  useEffect(() => {
    ...
    const handleTouchMove = (e) => {
      if (window.innerWidth > 768) return
      // allow native mobile scrolling so tall sections can reveal all content
    }
  ...
  return (
    <div className="chef-portfolio">
      ...
      >
        ...
        <div
          className="hero-giant-word-wrapper left-wrap"
          key={`left-giant-${currentChefIndex}`}
        >
          <motion.div
        ...
        <div
          className="hero-giant-word-wrapper right-wrap"
          key={`right-giant-${currentChefIndex}`}
        >
          <motion.div
            className="hero-giant-word"
            style={{ x: bgTextX, y: bgTextY }}
        ...
        <div className="hero-center-container">
          ...
          >
            ...
            >
              ...
              <span className="italic-serif">{chef.italicName}</span>
            </motion.h1>
      ...
      <section ref={philosophyRef} className="portfolio-philosophy">
        ...
        <motion.div
          ...
          key={`watermark-${currentChefIndex}`}
        >
        ...
        <div className="philosophy-grid">
          ...
          >
            ...
            <motion.div
              className="philosophy-pullquote"
              variants={scrollFadeInUp}
              key={`pullquote-${currentChefIndex}`}
            >
      ...
      <section className="portfolio-showcase" id="masterpieces-section">
        <div className="section-title-wrapper">
          ...
          <h2 className="showcase-title text-center">
            Curated Signature{" "}
            <span className="italic-accent">Masterpieces</span>
          </h2>
          <p className="showcase-lead text-center">
            Click on the dishes below to explore their visual artistry, exact
            botanical ingredients, complex taste profiles, and backstories.
          </p>
        </div>
        ...
        <div className="interactive-showcase-grid">
          ...
          <div className="showcase-selector-panel">
            ...
            <div
              ...
              key={`dish-list-${currentChefIndex}`}
            >
              ...
              >
                ...
                <div className="presentation-detail-card">
                  <div className="active-tag-row">
                    ...
                    <span className="dish-index-tag">
                      NO. 0{selectedDishIndex + 1}
                    </span>
                  </div>
        ...
        <div className="toolkit-header">
          ...
          <div className="toolkit-header-right">
            <p className="toolkit-lead">
              A master culinary craftsman is defined by their instruments and
              philosophies. We synthesize scientific precision with nature's raw
              botanical gifts to construct unforgettable edible journeys.
            </p>
          </div>
        </div>

        <div
          className="toolkit-cards-grid"
          key={`toolkit-grid-${currentChefIndex}`}
        >
      ...
      <section className="portfolio-timeline">
        <div className="timeline-grid-layout">
          <div className="timeline-left-intro">
            <div
              className="sticky-intro-content"
              key={`timeline-left-${currentChefIndex}`}
            >
              <div className="eyebrow-accent">
                <Sparkles size={16} />
              ...
              <p className="timeline-lead">
                Tracing {chef.fullName}'s path from dedicated foundational years
                to a globally recognized innovator in luxury gastronomy at
                AnandoFoods.
              </p>
          ...
          <div
            className="timeline-right-scrollable"
            key={`timeline-right-${currentChefIndex}`}
          >
